...
public class DataParser {
    ...
    public static KeyValue<String, type_a> parseDataTypeA(String type , String line) {
        try {
            ...
            if (matcher[0].length() != 0) { data.setNUMERO(Long.parseLong(matcher[0])); }
    ...
    public static KeyValue<String, type_c> parseDataTypeC(String type , String line) {
        try {
            ...
            if (matcher[1].length() != 0) { data.setNUMEROPDL(Long.parseLong(matcher[1])); }
            ...
            if (matcher[7].length() != 0) { data.setTELFIXE(Long.parseLong(matcher[7])); }
            if (matcher[8].length() != 0) { data.setTELBUREAU(Long.parseLong(matcher[8]));}
            if (matcher[9].length() != 0) { data.setTELPORTABLE(Long.parseLong(matcher[9]));}
